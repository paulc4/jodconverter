...
public class DefaultOfficeManagerConfiguration {
	...
	/**
	 * If using a proxy, {@link OfficeProcess} needs to know the real port
	 * number of the server process it will be starting and stopping.
	 * 
	 * @param realServerPort
	 *            The actual port that the Open/Libre LOffice Server should
	 *            listen on.
	 */
	public static void usingProxySoSetRealPort(int realServerPort) {
		OfficeProcess.realServerPort = realServerPort;
	}
	 ...
	 * available in the classpath, otherwise {@link LinuxProcessManager} on
	 * Linux and {@link PureJavaProcessManager} on other platforms.
	 * 
